"""
Django settings for tst_rn_eweb_dev_63251 project.
...
ROOT_URLCONF = 'tst_rn_eweb_dev_63251.urls'
...
WSGI_APPLICATION = 'tst_rn_eweb_dev_63251.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_rn_eweb_dev_63251 API",
    "DESCRIPTION": "API documentation for tst_rn_eweb_dev_63251 App",
    "VERSION": "v1",
}
